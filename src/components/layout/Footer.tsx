    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 md:gap-[var(--spacing-lg)] max-w-[var(--spacing-container-max)] mx-auto">
        ...
        <div className="flex flex-col gap-3 sm:col-span-2">
          ...
          >
            <span className="material-symbols-outlined text-[20px] shrink-0 group-hover:text-primary">call</span>
            <p className="font-[var(--font-body)] text-sm group-hover:underline">+91 88810 13100</p>
          </a>

          {/* Social Icons */}
          <div className="flex gap-4 mt-2">
            <a href="https://www.facebook.com/share/19CjreqU8i/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-on-surface-variant hover:text-[#1877F2] transition-colors" aria-label="Facebook">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="https://wa.me/918881013100" target="_blank" rel="noopener noreferrer" className="text-on-surface-variant hover:text-[#25D366] transition-colors" aria-label="WhatsApp">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.instagram.com/kesariyarestaurent_/" target="_blank" rel="noopener noreferrer" className="text-on-surface-variant hover:text-[#E4405F] transition-colors" aria-label="Instagram">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
